...
public class QuanLyVeMayBay extends JPanel {
    ...
    private JComboBox<String> hangVeComboBox; 
    ...
    private TrangChuPanel trangChuPanel;
        ...
        private JLabel hangVeField;
                ...
                private JPanel createModernHeader() {
                    ...
                    JLabel headerLabel = new JLabel("Quản Lý Hành Khách");
                ...
                private void addModernInputField(JPanel panel, String labelText, Component field, 
                ...
                private JPanel createModernInputPanel() {
                    ...
                    hangVeComboBox = new JComboBox<>(new String[]{"Phổ thông", "Thương gia", "Hạng nhất"});
                    hangVeComboBox.setFont(new Font("Segoe UI", Font.PLAIN, 14));
                    styleComboBox(hangVeComboBox);
                ...
                "Đã đặt", "Đã thanh toán", "Đã hủy"
            });
            trangThaiComboBox.setFont(new Font("Segoe UI", Font.PLAIN, 14));
            styleComboBox(trangThaiComboBox);
            ...
            addModernInputField(inputPanel, "Trạng Thái", trangThaiComboBox, gbc, 2);
            ...
            addModernInputField(inputPanel, "Hạng Vé", hangVeComboBox, gbc, 6);
            return inputPanel;
        }
        ...
        private void handleAddTicket() {
            try {
                VeMayBay ticket = controller.createVeMayBayFromInput(
                    ...
                    trangThaiComboBox.getSelectedItem().toString(), // Thay đổi ở đây
                    ...
                    hangVeComboBox.getSelectedItem().toString() 
                );
        ...
        // Helper methods
        private String getTextOrPlaceholder(Component field) {
    ...
    public void updateTableData(List<VeMayBay> veMayBayList) {
        String[] columnNames = {
            ...
            "Số Điện Thoại", "Địa Chỉ", "Email", "Ngày Sinh", "Quốc Tịch", "Hạng Vé", "Số Ghế"
        };
        ...
        table.getColumnModel().getColumn(13).setPreferredWidth(100); // Hạng Vé
        table.getColumnModel().getColumn(14).setPreferredWidth(80);  // Số Ghế
    }
    ...
    public void updateFieldsFromSelection(int selectedRow) {
        ...
        Object trangThai = tableModel.getValueAt(selectedRow, 7);
            if (trangThai != null) {
                for (int i = 0; i < trangThaiComboBox.getItemCount(); i++) {
                    if (trangThai.toString().equals(trangThaiComboBox.getItemAt(i))) {
        ...
        Object hangVe = tableModel.getValueAt(selectedRow, 13);
        Object soGhe = tableModel.getValueAt(selectedRow, 14);
    
        if (hangVe != null) {
            for (int i = 0; i < hangVeComboBox.getItemCount(); i++) {
                if (hangVe.toString().equals(hangVeComboBox.getItemAt(i))) {
                    hangVeComboBox.setSelectedIndex(i);
                    break;
                }
            }
        }
        ...
        for (JTextField field : new JTextField[]{
            ...
            cmndField, ngayDatField, giaVeField,
    ...
    public void clearFields() {
        ...
        hangVeComboBox.setSelectedIndex(0);
